                    ...
                    <div class="col-lg-9 click">
                        ...
                        <div class="input-group mrg_bot">
                            <select name="gender" disabled id="input5" class="form-control">
                                <option value="0" <?php if ($row['gender'] == 0) {echo 'selected="selected"';} ?>>не вказано</option>
                                <option value="1" <?php if ($row['gender'] == 1) {echo 'selected="selected"';} ?>>чоловік</option>
                                <option value="2" <?php if ($row['gender'] == 2) {echo 'selected="selected"';} ?>>жінка</option>
                        ...
                        <div class="input-group mrg_bot">
                            <select name="sex_pref" disabled id="input6" class="form-control">
                                <option value="0" <?php if ($row['sex_pref'] == 0) {echo 'selected="selected"';} ?>>не вказано</option>
                                <option value="1" <?php if ($row['sex_pref'] == 1) {echo 'selected="selected"';} ?>>гетеросексуал</option>
                                <option value="2" <?php if ($row['sex_pref'] == 2) {echo 'selected="selected"';} ?>>гомосексуал</option>
                                <option value="3" <?php if ($row['sex_pref'] == 3) {echo 'selected="selected"';} ?>>бісексуал</option>
                            </select>
                            <span class="input-group-btn">
                        ...
                        <div class="input-group mrg_bot">
                            <input name="address" type="text" class="form-control" disabled id="input7" value="<?php echo $row['address'];?>">
                            <span class="input-group-btn">
                        ...
                        <div class="input-group mrg_bot">
                            <input name="birthday" id="input8" type="text" class="form-control" disabled value="<?php echo $row['birthday'];?>">
                            <span class="input-group-btn">
                        ...
                        <div class="input-group mrg_bot">
                            <textarea name="info" class="form-control"  disabled id="input9"><?php echo $row['biography'];?></textarea>
                            <span class="input-group-btn">
        					    <input id="in6" class="btn btn-default" data-text="input9" type="submit" value="Змінити">
                            </span>
                        </div>
